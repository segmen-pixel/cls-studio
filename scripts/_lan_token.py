...
A non-loopback bind without ``CLS_API_TOKEN`` is refused at startup, because it
...
Used by scripts/windows/start_*.bat, scripts/macos/start_local_macos.sh and
scripts/start_local.sh. An explicit CLS_API_TOKEN in the environment always
...
def _settings_path() -> Path:
    projects_dir = os.environ.get("CLS_PROJECTS_DIR", "")
    if projects_dir:
