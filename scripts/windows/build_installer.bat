...
REM ============================================================
REM  cls-studio — Windows Installer Builder
REM  Creates a standalone Windows installer (.exe) with embedded Python + CUDA
REM
REM  Usage:
REM    scripts\windows\build_installer.bat
REM ============================================================
...
echo.
echo ================================================================
echo   cls-studio Installer Builder (Windows)
echo ================================================================
echo.
...
echo.
echo   Output: dist\v%APP_VERSION%\cls-studio-v%APP_VERSION%-win64-setup.exe
echo.
pause
...
if not exist "%REPO_ROOT%\apps\ui\dist\index.html" (
    echo.
    echo [STEP] Building React UI...
    pushd "%REPO_ROOT%\apps\ui"
    call npm install
    call npm run build
    if errorlevel 1 (
        popd
