...
import { EVAL_FP_COLOR, aurocOf, statWithAlpha, youdenThreshold } from "./separation";
...
export default function BankProjection({
  ...
  useEffect(() => {
    ...
    const tid = setTimeout(() => {
      ...
      onRawAnchors({ lo, hi: evalStats.thr, okMean, okStd, alpha, metric: evalMetric, k: evalTopK, values });
    }, 400);
    return () => clearTimeout(tid);
  }, [evalStats, evalResults, alpha, evalMetric, evalTopK, onRawAnchors]);
