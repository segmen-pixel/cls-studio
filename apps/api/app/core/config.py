...
# Kept equal to the root pyproject's version and the UI package's, and pinned
# there by apps/api/tests/test_version_is_one_number.py. This sat at "0.1.0"
# through the 0.2.0 and 0.2.1 releases, so /api/v1/health -- the endpoint you
# reach for to confirm WHICH build is live -- answered with a version that had
# not been true for two releases, and TRAINER_BUILD_ID stamped that same wrong
# number onto every trained artifact.
APP_VERSION = "0.2.2-post3"
