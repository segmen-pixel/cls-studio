...
from ..core.bank_images import staging_file_path
...
def staging_file(name: str) -> FileResponse:
    ...
    # Containment is decided by bank_images, the module that owns every
    # _staging/ path. This route used to re-implement resolve() +
    # is_relative_to() inline -- a second answer to a question that already
    # had an owner, which is precisely how the two drift apart.
    p = staging_file_path(d.parent, name)
