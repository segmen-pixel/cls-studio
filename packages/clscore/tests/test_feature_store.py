...
def test_assembly_concatenates_in_store_order_with_exact_row_index(tmp_path):
    ...
    assert bank.meta.normal_image_index == [
        {"name": "a.png", "entry_id": st.entries[0].id, "start": 0, "count": 4},
        {"name": "b.png", "entry_id": st.entries[1].id, "start": 4, "count": 6},
        {"name": "c.png", "entry_id": st.entries[2].id, "start": 10, "count": 5},
    ]
